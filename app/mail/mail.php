...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 587 'tls')
	  ->setUsername('melissa@beastcoastcreative.com')     
	  ->setPassword('bcc2017!')
	  ;
	...
	$message = Swift_Message::newInstance('A message from your website form')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('noreply@beastcoastcreative.com' => 'Website Form'))->setBody($messageText);
//                           ^                    ^
